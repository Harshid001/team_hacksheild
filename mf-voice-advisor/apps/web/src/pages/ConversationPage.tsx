...
export default function ConversationPage() {
  ...
  return (
    <main className="h-screen max-h-screen flex flex-col bg-gray-50 overflow-hidden relative">

      {/* ── Top Bar ─────────────────────────────────────────────── */}
      <header className="px-4 py-3 flex items-center justify-between bg-white border-b border-gray-200 flex-shrink-0 shadow-sm">
        {/* Exit Button */}
        <button
          onClick={() => {
            stopSpeaking()
          ...
          className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-gray-200 text-xs font-semibold text-gray-600 hover:text-red-600 hover:border-red-200 hover:bg-red-50/50 transition-all focus:outline-none focus:ring-2 focus:ring-red-500 select-none"
          ...
          <AnimatePresence>
            {messages.length === 0 && !isAiTyping && (
              ...
              >
                ...
                <p className="text-base font-display font-semibold text-slate-700">
                  {t.convAdvisorReady}
                </p>
